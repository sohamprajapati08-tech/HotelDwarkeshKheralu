/**
 * Hotel Dwarkesh - Client-side Auth & Session Engine
...
(function () {
    const AUTH_TOKEN_KEY = 'dwarkesh_token';
    const AUTH_USER_KEY = 'dwarkesh_user';
    ...
    window.handleDirectMobileLogin = async function () {
        ...
        window.HotelAuth.showToast(`Welcome to Hotel Dwarkesh, ${data.user.name}!`, 'success');
    ...
    // Clicking the "HOTEL DWARKESH" logo 3 times rapidly (within 1.5s) opens /admin
    // =========================================================================
        ...
        logoElements.forEach(el => {
            el.addEventListener('click', function (e) {
                ...
                if (logoClickCount === 1) {
                    ...
                    logoClickCount = 0;
                    e.preventDefault();
                    window.HotelAuth.showToast('Opening Hotel Dwarkesh Admin Portal...', 'info');
                    setTimeout(() => {
